...
<div id="jzqddet" class="my-com-lessondet" lesson-id="66">
    ...
    <?php if($type == 'palace'){?>
        <div class="tui-btn-bx">
            <div class="<?php if(in_array($orderInfo['is_payback'],array('0'))){echo 'jz-tui-btn';}?>  layui-btn layui-btn-radius layui-btn-warm <?php if(in_array($orderInfo['is_payback'],array('1','2'))){echo 'subed-tuikuan';}?>">
                <?php if($orderInfo['is_payback']=='0'){echo '申请退款';}elseif($orderInfo['is_payback']=='1'){echo '待退款';}elseif($orderInfo['is_payback']=='2'){echo '已退款';}?>
            </div>
        </div>
    <?php }?>
</div>
...
<script type='text/javascript' src="<?php echo PUBLICPATH; ?>dier/js/index.bf.js?t=<?php echo time();?>"></script>